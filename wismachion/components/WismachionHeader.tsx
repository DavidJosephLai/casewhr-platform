      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            {user ? (
              <>
                <Button variant="outline" onClick={onPortal} className="gap-2 border-cyan-400 text-cyan-300 hover:bg-blue-800">
                  <Settings className="w-4 h-4" />
                  My Licenses
                </Button>
                <Button variant="ghost" onClick={onLogout} className="gap-2 text-blue-100 hover:bg-blue-700">
                  <LogOut className="w-4 h-4" />
                  Logout
                </Button>
              </>
            ) : (
              <Button onClick={onLogin} className="gap-2 bg-cyan-500 hover:bg-cyan-600 text-white shadow-lg">
