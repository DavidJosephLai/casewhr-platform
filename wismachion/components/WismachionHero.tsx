      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white">
            <div className="inline-block mb-4 px-4 py-2 bg-cyan-500/20 backdrop-blur-sm rounded-full text-sm font-medium border-2 border-cyan-400 text-cyan-300">
            ...
            <p className="text-xl md:text-2xl mb-4 text-cyan-300">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button 
                size="lg" 
                variant="outline"
                className="border-2 border-cyan-400 text-cyan-300 hover:bg-blue-800 text-lg px-8"
                onClick={onFreeTrial}
              >
                Try Free Trial
              </Button>
...
function FeatureCard({ icon, title, description }: { icon: React.ReactNode; title: string; description: string }) {
  return (
    <div className="bg-blue-800/40 backdrop-blur-sm border-2 border-cyan-500 rounded-xl p-6 hover:bg-blue-700/50 hover:border-cyan-400 transition-all shadow-lg hover:shadow-xl">
