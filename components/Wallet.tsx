                ...
                <>
                  ...
                  >
                    {loading ? (
                      ...
                      <svg style={{ height: '24px', width: 'auto' }} viewBox="0 0 124 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                        {/* PayPal SVG */}
                      </svg>
                    )}
                  </Button>
                ...
                <>
                  ...
                  >
                    {loading ? (
                      ...
                      <svg style={{ height: '24px', width: 'auto' }} viewBox="0 0 124 33" fill="white" xmlns="http://www.w3.org/2000/svg">
