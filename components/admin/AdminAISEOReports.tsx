...
export default function AdminAISEOReports() {
  ...
  const content = {
    en: {
      pageTitle: 'AI SEO Reports Manager',
      subtitle: 'View and manage all AI SEO reports from all users',
    ...
    'zh-TW': {
      pageTitle: 'AI SEO 報告管理器',
      subtitle: '查看並管理所有用戶的 AI SEO 報告',
      loadButton: '載入報告',
      loading: '載入中...',
      refresh: '刷新',
      totalReports: '總報告數',
    ...
    'zh-CN': {
      pageTitle: 'AI SEO 报告管理器',
      subtitle: '查看并管理所有用户的 AI SEO 报告',
      loadButton: '加载报告',
      loading: '加载中...',
      refresh: '刷新',
      totalReports: '总报告数',
  ...
  const loadReports = async () => {
    setIsLoading(true);
    try {
      console.log('🔍 [AdminAISEOReports] Loading all AI SEO reports...');
      ...
      console.log('📦 [AdminAISEOReports] Total KV items:', allData.length);
      ...
      console.log('✅ [AdminAISEOReports] Found reports:', seoReports.length);
      ...
      console.error('❌ [AdminAISEOReports] Error:', error);
